/**
 * 🇧🇩 নেভিগেশন বার (Responsive Top Navigation & Role Bar)
 * 
 * ব্যবহারকারীর ভূমিকা অনুযায়ী মেনু আইটেম ফিল্টার করে এবং যেকোনো সময়
 * টেস্টের সুবিধার্থে ভূমিকা পরিবর্তনের ড্রপডাউন অফার করে।
 */
